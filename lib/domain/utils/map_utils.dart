...
class RaceRouteAndPoints{
  ...
  String getMarkerTitle(String markerKey) {
    String title = switch (markerKey) {
      hidrationPointKey => hidrationPointTitle,
        hidrationPointKey1 => hidrationPointTitle,
        hidrationPointKey2 => hidrationPointTitle,
        hidrationPointKey3 => hidrationPointTitle,
        hidrationPointKey4 => hidrationPointTitle,
        hidrationPointKey5 => hidrationPointTitle,
        hidrationPointKey6 => hidrationPointTitle,
        hidrationPointKey7 => hidrationPointTitle,
        hidrationPointKey8 => hidrationPointTitle,
        hidrationPointKey9 => hidrationPointTitle,
        hidrationPointKey10 => hidrationPointTitle,
      exitPointKey => exitPointTite,
      finishPointKey => finishPointTitle,
      medicPointKey => medicPointTitle,
        medicPointKey1 => medicPointTitle,
        medicPointKey2 => medicPointTitle,
        medicPointKey3 => medicPointTitle,
        medicPointKey4 => medicPointTitle,
        medicPointKey5 => medicPointTitle,
        medicPointKey6 => medicPointTitle,
        medicPointKey7 => medicPointTitle,
        medicPointKey8 => medicPointTitle,
        medicPointKey9 => medicPointTitle,
        medicPointKey10 => medicPointTitle,
  ...
  BitmapDescriptor getMarkerColor(String markerKey){
    double color = switch (markerKey){
      ...
      hidrationPointKey1 => BitmapDescriptor.hueAzure,
      hidrationPointKey2 => BitmapDescriptor.hueAzure,
      hidrationPointKey3 => BitmapDescriptor.hueAzure,
      hidrationPointKey4 => BitmapDescriptor.hueAzure,
      hidrationPointKey5 => BitmapDescriptor.hueAzure,
      hidrationPointKey6 => BitmapDescriptor.hueAzure,
      hidrationPointKey7 => BitmapDescriptor.hueAzure,
      hidrationPointKey8 => BitmapDescriptor.hueAzure,
      hidrationPointKey9 => BitmapDescriptor.hueAzure,
      hidrationPointKey10 => BitmapDescriptor.hueAzure,
      ...
      medicPointKey1 => BitmapDescriptor.hueRed,
      medicPointKey2 => BitmapDescriptor.hueRed,
      medicPointKey3 => BitmapDescriptor.hueRed,
      medicPointKey4 => BitmapDescriptor.hueRed,
      medicPointKey5 => BitmapDescriptor.hueRed,
      medicPointKey6 => BitmapDescriptor.hueRed,
      medicPointKey7 => BitmapDescriptor.hueRed,
      medicPointKey8 => BitmapDescriptor.hueRed,
      medicPointKey9 => BitmapDescriptor.hueRed,
      medicPointKey10 => BitmapDescriptor.hueRed,
