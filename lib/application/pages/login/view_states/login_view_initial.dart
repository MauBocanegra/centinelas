...
class LoginViewInitial extends StatelessWidget {
  const LoginViewInitial({super.key});
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Platform.isIOS ?
                  AppleSignInButton(
                    onAppleLoginFailure: () async {
                      await showModalActionSheet<String>(
                        context: context,
                        message: appleSignInFailed,
                        isDismissible: false,
                        cancelLabel: appleSignInFailedButton,
                      );
                    },
                  )
                      :
